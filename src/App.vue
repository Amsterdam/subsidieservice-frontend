    ...
    <div id="nav" class="type-nav-primair">
      <nav class="container">
        <ul class="links horizontal">
          ...
          <li v-if="currentUser">
            <a @click="$router.push('/overview')">
              <span class="linklabel">Overview</span>
            </a>
          </li>
          <li v-if="!currentUser">
          ...
          <li v-if="isAdmin">
            <a @click="$router.push('/admin')">
              <span class="linklabel">Administration</span>
            </a>
          </li>
        </ul>
        <ul class="links horizontal">
          <li>{{ currentUser }}</li>
          <li v-if="currentUser">
            <button class="action primary" @click="logout">
              <span>Logout</span>
            </button>
          </li>
        </ul>
...
import credentialStorage from "@/services/user/credential.storage";
